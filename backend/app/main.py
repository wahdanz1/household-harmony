...
app = FastAPI(
    ...
    version="1.0.0",
    description="Backend API for Household Harmony budgeting app with Swedish tax intelligence",
)
...
from app.routers import health, tax, llm, api_keys, demo, auth_recovery
