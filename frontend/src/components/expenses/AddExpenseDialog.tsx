...
const expenseTypes = [
    {
        ...
        icon: Home,
        color: "bg-info/10 hover:bg-info/20 border-info/20",
        iconColor: "text-info",
    },
    {
        ...
        icon: Repeat,
        color: "bg-accent-purple/10 hover:bg-accent-purple/20 border-accent-purple/20",
    ...
    },
    {
        ...
        icon: Zap,
        color: "bg-alert/10 hover:bg-alert/20 border-alert/20",
